...
| ISS-013 underscore naming | Accepted | Do not encode inheritance in display names. Record superclass and specialisation explicitly in FSM. Apply the inherited-property matching and multiplicity-zero deletion rules defined by the framework. |
