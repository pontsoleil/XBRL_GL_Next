...
| P0-18 | Blocker | WORK specialization 18列出力とgraphwalk旧15列入力の不整合 | FSM 14列、BSM 15列、LHM/HMD 17列をPoC実装基準とした。現行programは未対応 | 基準仕様、program、fixture、期待結果及び試験を対応一式として承認後に登録する | Phase 1 |
...
| P0-29 | High | 旧・新LHM/HMD契約の識別 | taxonomy version `2026-12-31`から17列契約とmanifest contract name／versionを必須化 | schemaとconsumer拒否条件を実装前に承認する | Phase 1 |
