...
正規project module namespaceは`https://www.xbrl.or.jp/taxonomy/xbrl-gl-next/{module}`です。予定taxonomy version date `2026-12-31`は物理ファイル名だけに残し、namespace URIには含めません。このversion dateはpublic releaseが既に承認済みであることを意味しません。
